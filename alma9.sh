...
tee -a /usr/lib/systemd/system/mariadb.service <<EOF
...
##Install CampaignKings WebPhone
cd /var/www/html
...
cd /home
wget https://vicidialhelp.com/files/dynportal.zip
wget https://vicidialhelp.com/files/firewall.zip
wget https://vicidialhelp.com/files/aggregate
wget https://vicidialhelp.com/files//VB-firewall
...
Thank you for choosing Campaign Kings's auto installer!

Visit our Knowledge Base at https://www.vicidialhelp.com

Support: info@vicidialhelp.com
EOF
